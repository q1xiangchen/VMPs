...
def test(cfg):
    ...
    checkpoint_name = cfg.TEST.CHECKPOINT_FILE_PATH.split("/")[-1].split(".")[0]
    log_name = f"{data_name}_{model_name}_{checkpoint_name}"
    ...
    test_name = "test"     ## CHANGE THIS ROOT
    test_loader = loader.construct_loader(cfg, test_name)
